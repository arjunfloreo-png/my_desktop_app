...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
                ...
                Center(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          labelController.text.isEmpty ? 'Label' : labelController.text,
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: isSel ? Border.all(color: Colors.black45) : null,
                        ),
  ...
  final List<Map<String, String>> availableVideos = [
    {'title': 'Walk  Video', 'url': 'https://cdn.jsdelivr.net/gh/arjunfloreo-png/speech_animation_1@main/walk_animation.mp4'},
    {'title': 'Stomp Video', 'url': 'https://cdn.jsdelivr.net/gh/arjunfloreo-png/speech_animation_1@main/stomp_animation.mp4'},
    {'title': 'Stand Video', 'url': 'https://cdn.jsdelivr.net/gh/arjunfloreo-png/speech_animation_1@main/stand_animation.mp4'},
    {'title': 'Fly Video',   'url': 'https://cdn.jsdelivr.net/gh/arjunfloreo-png/speech_animation_1@main/fly_animation.mp4'},
    {'title': 'Dance Video', 'url': 'https://cdn.jsdelivr.net/gh/arjunfloreo-png/speech_animation_1@main/dance_animation.mp4'},
    {'title': 'Climb Video', 'url': 'https://cdn.jsdelivr.net/gh/arjunfloreo-png/speech_animation_1@main/climb_animation.mp4'},
  ];
  ...
  Future<void> initAgora() async {
    ...
    _engine.registerEventHandler(RtcEngineEventHandler(
      onJoinChannelSuccess: (connection, elapsed) => setState(() => _localUserJoined = true),
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              children: [
                _tinyIconBtn(
                  icon: (widget.selectedRole == UserRole.therapist ? isClientMuted : isTherpistMuted)
                      ? Icons.mic_off
                      : Icons.mic,
                  onTap: () {
                ...
                _tinyIconBtn(
                  icon: (widget.selectedRole == UserRole.therapist ? isTherpistvideoMuted : isClientvideoMuted)
                      ? Icons.videocam_off
                      : Icons.videocam,
                  onTap: () {
                    if (widget.selectedRole == UserRole.therapist) {
                      setState(() => isTherpistvideoMuted = !isTherpistvideoMuted);
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    if (widget.selectedRole == UserRole.therapist) ...[
                      const Icon(Icons.swap_horiz, color: Colors.white70, size: 12),
                      const SizedBox(width: 3),
                      const Text('2× swap', style: TextStyle(color: Colors.white70, fontSize: 9)),
                    ],
                  ],
                ),
              ),
          ...
          Padding(
            ...
            child: Column(
              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        left: 8,
                                        child: _livePill(
                                          widget.selectedRole == UserRole.therapist ? "Therapist" : "Client",
                                        ),
                                      ),
                                      Positioned(
                                        top: 6,
                ...
                if (widget.selectedRole == UserRole.therapist) _bottomControlsBar(),
              ],
            ),
          ),
            ...
            Row(
              children: [
                GestureDetector(
                  ...
                  child: Icon(
                    _isVolumeMuted ? Icons.volume_off : _videoVolume < 0.4 ? Icons.volume_down : Icons.volume_up,
                ...
                Expanded(
                  child: _thinSlider(
                    value: _videoPosition.inMilliseconds.toDouble().clamp(
                      0,
                      _videoDuration.inMilliseconds.toDouble().clamp(1, double.infinity),
                    ),
                    max: _videoDuration.inMilliseconds.toDouble().clamp(1, double.infinity),
                    onChanged: (v) async {
          ...
          Row(
            ...
            children: [
              ...
              _actionButton(
                ...
                isButton: false,
                label: '🏅 REWARD BOX',
                style: _isRewardDrawerOpen ? _ActionStyle.filled : _ActionStyle.outline,
                onTap: _toggleRewardDrawer,
              ),
            ],
          ),
  ...
  Widget _actionButton({
    ...
    switch (style) {
      case _ActionStyle.filled:
        deco = BoxDecoration(
          border: Border.all(width: 4, color: isDisabled ? const Color.fromARGB(255, 200, 238, 223) : const Color(0xff005735)),
          color: isDisabled ? const Color.fromARGB(255, 200, 238, 223) : const Color(0xFF00bd74),
          borderRadius: BorderRadius.circular(30),
        );
        textStyle = const TextStyle(color: Color(0xffdaf9ed), fontWeight: FontWeight.w700, fontSize: 15);
        break;
      case _ActionStyle.soft:
        deco = BoxDecoration(
          border: Border.all(color: isDisabled ? const Color.fromARGB(255, 200, 238, 223) : const Color(0xff005735), width: 4),
          color: isDisabled ? const Color.fromARGB(255, 200, 238, 223) : const Color(0xFF00bd74),
          borderRadius: BorderRadius.circular(30),
        );
        textStyle = const TextStyle(color: Color(0xffdaf9ed), fontWeight: FontWeight.w600, fontSize: 15);
        break;
      case _ActionStyle.outline:
        ...
        textStyle = TextStyle(color: const Color(0xffdaf9ed), fontWeight: FontWeight.w600, fontSize: small ? 11 : 15);
        break;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: EdgeInsets.symmetric(horizontal: small ? 14 : 20, vertical: small ? 8 : 10),
        decoration: deco,
        child: isButton
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Icon(Icons.play_circle_outline, size: 32, color: Color(0xFF00796B)),
                          const SizedBox(height: 6),
                          Text(
                            video['title']!,
